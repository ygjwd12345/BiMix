...
from configs.evaluate_config import get_arguments
...
def main(j):
    ...
    args.restore_from='./snapshots/DeepLabclassmix_step1/dannet'+str(j)+'.pth'
    args.restore_from_light='./snapshots/DeepLabclassmix_step1/dannet_light'+str(j)+'.pth'
...
if __name__ == '__main__':
    ...
    #     j=(i+1)*1000
    #     main(j)
    #     mIou=compute_mIoU('./dataset/Dark_Zurich', './result/dannet_RefineNet', './dataset/lists')
